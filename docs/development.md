...
下一目标：推进 trusted-key enrollment UX、更多 rule override regression、MCP tool-call recorder 或 local file ingestion，同时继续保持 schema 可表示 coding-agent session 和 browser task。
