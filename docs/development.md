...
下一目标：推进 trusted-key enrollment UX、更多 rule override regression、或一个 coding-agent trace source，同时继续保持 schema 可表示 coding-agent session 和 browser task。
...
- Claude Code / Codex trace importer，基于现有 manifest schema
