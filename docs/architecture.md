...
9. Signed packet provenance, trusted-key enrollment hardening, rule override hardening, and imported external-agent trace source.
10. Credential broker for task-scoped provider access.
11. MCP tool-call recorder, local file ingestion, and browser/computer-use adapters.
