...
9. Signed packet provenance, trusted-key enrollment hardening, rule override hardening, imported external-agent trace source, MCP trace import, and local file ingestion.
